...
import org.sphic.tps.model.Material;
 ...
 * 
 * @see org.sphic.tps.model.Material
...
public class MaterialDAO extends BaseHibernateDAO {
	...
	public Material findById(java.lang.Integer id) {
		...
		try {
			Material instance = (Material) getSession().get(
					"org.sphic.tps.model.Material", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Material> findByExample(Material instance) {
		...
		try {
			List<Material> results = (List<Material>) getSession()
					.createCriteria("org.sphic.tps.model.Material")
	...
	public List<Material> findByDescription(Object description) {
		return findByProperty(DESCRIPTION, description);
	}

	public List<Material> findByValue(Object value) {
