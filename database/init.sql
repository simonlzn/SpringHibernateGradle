...
CREATE TABLE `slice` (
    ...
    `row` INTEGER COMMENT 'Number of rows',
    `column` INTEGER COMMENT 'Number of columns',
    `rowspacing` INTEGER COMMENT 'Spacing for rows',
    `columnspacing` INTEGER COMMENT 'Spacing for columns',
